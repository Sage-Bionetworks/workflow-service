...
def main(argv=sys.argv[1:]):
    ...
    if args.log:
        ...
        sys.stdout.write(response["run_log"]["stdout"])
        sys.stdout.write(response["run_log"]["stderr"])

        # sys.stdout.write(requests.get(response["run_log"]["stdout"], headers=auth).text)
